fetch('./datos.json')
    ...
    .then(notasGuardadas => principal(notasGuardadas))
    .catch(error => console.log(error))
function principal(notas) {
    ...
    function guardarNotas() {
        ...
        if (entradaTituloNota !== "" || entradaParrafoNota !== "") {
            notas.push({ id: notas.length, titulo: entradaTituloNota, parrafo: entradaParrafoNota })
    ...
    <section id="verNota">
        ...
        botonBuscarNotas.addEventListener("click", function () {
            buscador(notas, buscarNotas.value)
        })
